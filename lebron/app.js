...
function reloadPosts() {
    ...
    .then(posts => {
        ...
        posts.forEach((post) => {
            ...
            // Add the like and unlike buttons to the post
            ...
            // Add both the post content and buttons to the card
...
// This function runs when the page loads and handles the post submission
function load() {
...
window.onload = load; // Automatically run load() when page is ready
